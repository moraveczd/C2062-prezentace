...
\frame{
	...
	\textbf{Ruthenium}
	\begin{itemize}
		\item Krystaluje v kubické plošně centrované soustavě (FCC).
		...
		\item Důležitou sloučeninou je černý \textit{chlorid ruthenitý}, \ce{RuCl3}, který je výchozí látkou pro syntézu sloučenin ruthenia.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Přírodní palladium se skládá ze šesti stabilních izotopů a jednoho nestabilního.
		\begin{itemize}
			\item \ce{^{102}Pd}; 1,02~\%
		...
		\end{itemize}
		\item Dále známe 23 radioizotopů.
...
\frame{
	...
	\begin{itemize}
		...
		\item V roce 2021 byla roční produkce ruthenia 472 tun.\footnote[frame]{\href{https://pubs.usgs.gov/myb/vol1/2021/myb1-2021-platinum-group.pdf}{Platinum-group metals}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Roční celosvětová produkce se pohybuje pod 30 tun, hlavními producenty jsou Jižní Afrika a Rusko.\footnote[frame]{\href{https://pubs.usgs.gov/myb/vol1/2021/myb1-2021-platinum-group.pdf}{Platinum-group metals}}
	\end{itemize}
	\begin{figure}
...
\frame{
	...
	\begin{itemize}
		...
		\item Celosvětová produkce palladia do roku 2021 byla 214 tun.\footnote[frame]{\href{https://pubs.usgs.gov/myb/vol1/2021/myb1-2021-platinum-group.pdf}{Platinum-group metals}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Dále katalyzuje velké množství průmyslových procesů, např. výrobu kyseliny octové (Monsanto proces, viz další strana).
	\end{itemize}
	\begin{figure}
...
\frame{
	...
	\begin{itemize}
		...
		\item Byl vyvinut v 70. letech 19. století společností Monsanto.
		\item Methanol reaguje s oxidem uhelnatým:\footnote[frame]{\href{https://chem.libretexts.org/Bookshelves/Inorganic_Chemistry/Inorganic_Chemistry_(LibreTexts)/14\%3A_Organometallic_Reactions_and_Catalysis/14.03\%3A_Organometallic_Catalysts/14.3.03\%3A_Monsanto_Acetic_Acid_Process}{Monsanto Acetic Acid Process}}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Hydrid také vykazuje supravodivost, stechiometrii PdH odpovídá kritická teplota je 9~K.
		\item U nestechiometrických fází byla také pozorována vysokoteplotní supravodivost\footnote[frame]{\href{https://doi.org/10.1016/j.jallcom.2006.07.082}{Remarks on superconductivity in PdH}} za nízkého tlaku (na rozdíl od hydridů lanthanu).\footnote[frame]{\href{https://doi.org/10.1016/S0921-4534(02)02745-4}{Possibility of high temperature superconducting phases in PdH}}
