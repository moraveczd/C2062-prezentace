	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item Za silně oxidačních podmínek dochází k oxidaci a interkalaci za vzniku interkalátů grafitu.
			\end{itemize}
			\vfill
		\end{column}
		\begin{column}{0.5\textwidth}
...
\frame{
	...
	\begin{itemize}
		...
		\item Grafen je 200$\times$ pevnější než ocel, zároveň je ale i lehčí.
...
\frame{
	...
	\begin{itemize}
		...
		\item Velká část je zpracovávána na ferosilicia, což jsou slitiny železa a křemíku.
...
\frame{
	...
	\begin{itemize}
		...
		\item V nanoskopické podobě se dokáže olovo dostat do mozku přímo přes čichové buňky.\footnote[frame]{\href{https://vedavyzkum.cz/veda/veda/vdechovane-olovnate-nanocastice-obchazeji-ochranu-mozku}{Vdechované olovnaté nanočástice obcházejí ochranu mozku}}
		...
		\item Toxicita olova je velkým problémem u dětí, u nichž může zpomalit duševní vývoj.\footnote[frame]{\href{https://www.sciencedaily.com/releases/2022/03/220307162011.htm}{Lead exposure in last century shrank IQ scores of half of Americans, study finds}} Typickými příznaky otravy olovem jsou bledost obličeje a rtů, nechutenství, anémie.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Olovo se do prostředí dostává z barviv, střeliva, akumulátorů, olovnatého benzínu a dalších zdrojů.\footnote[frame]{\href{https://doi.org/10.1186/s12302-019-0249-2}{Assessing the leaching behavior of different gunshot materials in natural spring waters}}
		\item Koncentrace olova v životním prostředí se stanovuje pomocí AAS, MS nebo diferenční pulzní voltametrie.\footnote[frame]{\href{https://doi.org/10.61919/jhrr.v4i3.1294}{Evaluation of Heavy Metals in Various Brands of Tobacco Cigarettes Marketed in Pakistan and Their Implications in Public Health}}
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.2\textheight]{img/LeadPlombToxic_cartridgeCartoucheYellow.jpg}
		\caption*{Nábojnice se střelivem.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:LeadPlombToxic_cartridgeCartoucheYellow.jpg}{Lamiot/Commons}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Redukci lze provést uhlíkem nebo oxidem uhelnatým.
		\item Lze využít i přímo galenit (podobně jako u mědi).
	\end{itemize}
	\begin{figure}
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{itemize}
				...
				\item \textit{Bezolovnaté pájky} -- prosazovány z ekologických důvodů, ale mají odlišné vlastnosti (vyšší teplotu tání, jinou smáčivost) než klasické pájky.
			\end{itemize}
		\end{column}
		...
		\begin{column}{.35\textwidth}
			...
			\begin{itemize}
				\item \textit{SAC} -- slitiny cínu, stříbra a/nebo mědi (\textbf{S}n/\textbf{A}g/\textbf{C}u).
...
\frame{
	...
	\begin{itemize}
		...
		\item Je to nejčastěji používaný transparentní vodivý oxid.
...
\frame{
	...
	\begin{itemize}
		...
		\item \textbf{Oxid germaničitý}, \ce{GeO2}, bílý prášek, je komerční zdroj germania.
...
\frame{
	...
	\begin{tabular}{|l|l|l|l||l|l|l|l|}
		...
		\ce{GeF2} & bílá & 110 & 130 & \ce{GeF4} & bb. & $-$15 & $-$36,5 \\
		& & & & & & & sublimace \\\hline
