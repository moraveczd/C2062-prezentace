		...
		\begin{column}{.7\textwidth}
			...
			\begin{center}
				\begin{tabular}{|l|l|}
					...
					$^{283}$Rg & 5,1 min (nepotvrzený) \\\hline
					$^{286}$Rg & 10,7 min (nepotvrzený) \\\hline
				\end{tabular}
			\end{center}
		\end{column}
...
\frame{
	...
	\begin{itemize}
		...
		\item Patří mezi první kovy, se kterými člověk pracoval.
...
\frame{
	\frametitle{}
	\vfill
	Zlato se rozpouští v lučavce královské.
	\begin{columns}
		\begin{column}{.3\textwidth}
			\begin{figure}
...
\frame{
	...
	\begin{itemize}
		...
		\item Zbytek je zahříván s křemenem nebo vápnem, většina kovů tak přejde do strusky.
...
\frame{
	...
	\begin{itemize}
		...
		\item Zhruba stejné množství zlata je stále uloženo v zemi.\footnote[frame]{\href{https://www.ceskenoviny.cz/zpravy/loziska-zlata-v-cr-podle-geologu-skryvaji-77-tun-dostupnych-zasob/2743586}{Diamo: Ložisko u Zlatých Hor skrývá skoro 11 tun zlata}}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Měrný elektrický odpor\footnote[frame]{Hodnota elektrického odporu 1 m vodiče s jednotkovým průřezem} mědi je 16,78 n$\Omega$.m při teplotě 20~$^\circ$C.
...
\frame{
	...
	\begin{itemize}
		...
		\item Měděné dráty se také využívají pro konstrukci vinutí cívek motorů.
	\end{itemize}
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			...
			\begin{itemize}
				...
				\item Nevýhodou stříbra je pomalé černání způsobené reakcí se stopami sulfanu.
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.65\textheight]{img/Anhydrous_CuSO4.png}
		\caption*{Krystalová struktura bezvodého síranu měďnatého.\footnote[frame]{\href{https://commons.wikimedia.org/wiki/File:Anhydrous_CuSO4.png}{Zdroj: Andif1/Commons}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[width=\textwidth]{img/Copper-sulfate-pentahydrate.png}
		\caption*{Krystalová struktura modré skalice.\footnote[frame]{\href{https://commons.wikimedia.org/wiki/File:Copper(II)-sulfate-pentahydrate-Cu1-coord-xtal-2007-CM-3D-balls.png}{Zdroj: Ben Mills/Commons}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Denní dávka mědi by se měla pohybovat mezi 1 a 3~mg. Zdroji mědi jsou ořechy, houby, korýši, měkkýši, játra a kakao.
