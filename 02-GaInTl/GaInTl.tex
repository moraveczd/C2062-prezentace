...
\frame{
	\frametitle{}
	\begin{itemize}
		\item Vysoké afinity hliníku ke kyslíku se využívá v aluminotermii.\footnote[frame]{\href{https://ebedox.cz/aluminotermie/}{Aluminotermie}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Relativistické efekty mohou stabilizovat oxidační stav +I; chemické vlastnosti však zatím nejsou experimentálně ověřeny.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Gallium a indium nejsou vysoce toxické, ale thallium se řadí mezi extrémně toxické prvky.\footnote[frame]{\href{https://www.webelements.com/thallium/}{Thallium: the essentials}}
		\item Gallium krystaluje v orthorombické krystalové soustavě.
		\item Indium má tělesně centrované tetragonální mřížce, každý atom india sousedí se čtyřmi dalšími ve vzdálenosti 324~pm a osmi ve vzdálenosti 336~pm.
		\item Thallium krystaluje v nejtěsnějším hexagonálním uspořádání (HCP). Při tlaku na 4~GPa přechází na kubickou plošně centrovanou soustavu (FCC).\footnote[frame]{\href{https://doi.org/10.1107/S002188989400720X}{A high-pressure study of thallium}}
		\item Teploty tání jsou poměrně nízké.
		\item Všechny tři kovy vytvářejí sloučeniny v oxidačních číslech I a III.
	\end{itemize}

	\begin{alertblock}{Oxidační stav +I}
		\begin{itemize}
			\item Stálost oxidačního stavu I stoupá v řadě Al $<$ Ga $<$ In $<$ Tl.
			\item Nestabilita oxidačního stavu +III u thallia je dána efektem inertního elektronového páru
		\end{itemize}
	\end{alertblock}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Zastoupení v zemské kůře je asi 15--20~ppm, to přibližně odpovídá dusíku, niobu, lithiu a olovu.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item \textit{Oxid inditý} (\ce{In2O3}) je v amorfním stavu nerozpustný ve vodě, ale rozpouští se v kyselinách. Krystalický je nerozpustný jak ve vodě, tak v kyselinách. Lze jej připravit zahřívání vhodné indité soli -- hydroxidu, uhličitanu, dusičnanu nebo síranu.
...
\frame{
	...
	\begin{itemize}
		...
		\item Hmotnostní složení: 74 \% In, 18 \% O, and 8 \% Sn.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item \textit{Sulfid inditý} (\ce{In2S3}) je pevná látka, zapáchající po zkažených vejcích. Zápach je způsoben sulfanem, který vzniká hydrolýzou.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Jednostěnné nanotrubice \ce{In2S3} lze připravit difůzí z rozpouštědla (oleylamin) do kapaliny, kde jsou nerozpustné (ethanol).\footnote[frame]{\href{https://doi.org/10.1038/ncomms9756}{General synthesis of inorganic single-walled nanotubes}}
	\end{itemize}
	\begin{figure}
