...
\frame{
	...
	\begin{itemize}
		...
		\item Kadmium může také podpořit rozvoj rakoviny plic a prostaty. Na druhou stranu, u některých nádorů může kadmium působit jako supresivní látka.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\textbf{Rtuť}
	\begin{itemize}
		\item Kapalný, ušlechtilý a toxický kov s vysokou hustotou.
		\item Dobrý vodič elektřiny, ale špatně vede teplo.
		\item Má nejnižší teplotu varu a jednu z nejnižších teplot tání ze všech stabilních kovů.
...
\frame{
	...
	\begin{columns}
		...
		\begin{figure}
			...
			\caption*{Heike Kammerlingh Onnes.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:Kamerlingh_portret.jpg}{Commons}}}
		\end{figure}
	\end{column}
	\end{columns}
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Oxid zinečnatý se využívá v zubních pastách, protože:
		\begin{itemize}
			\item má antibakteriální účinky
			\item má protizánětlivé účinky
			\item má i bělící účinky
			\item posiluje zubní sklovinu
			\item je netoxický
		\end{itemize}
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.35\textheight]{img/Tandpasta.jpg}
		\caption*{Zubní pasta.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:Tandpasta.jpg}{M.Minderhoud/Commons}}}
	\end{figure}
	\vfill
}
...
\frame{
	\frametitle{}
	\vfill
	\begin{block}{Využití rtuti}
		\begin{itemize}
			\item Od využívání rtuti se postupně ustupuje, kvůli ekologickým a zdravotním problémům.
			\item V průmyslu se obrovská množství rtuti využívala pro výrobu chloru elektrolýzou solanky (NaCl), ale v dnešní době se využívá spíše membránová elektrolýza.\footnote[frame]{\href{http://ucitelchemie.upol.cz/materialy/vkpch/vyroba_cl_a_naoh_text_pro_ucitele.pdf}{Výroba chloru a hydroxidu sodného elektrolytickými metodami}}
			\item Páry rtuti se využívají v zářivkách a výbojkách jako zdroj UV záření.\footnote[frame]{\href{https://www.capecod.gov/wp-content/uploads/2022/03/Mercury-in-Lighting.pdf}{Mercury in Lighting}}
			\item Slitiny rtuti s dalšími kovy, amalgámy, se využívají v medicíně, při těžbě zlata a také v elektrochemii. Lze je také použít jako redukční činidlo v chemické syntéze.
		\end{itemize}
	\end{block}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Bezvodé fluoridy lze připravit reakcí fluorovodíku se Zn nebo fluoru s~Cd a Hg.
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Syntéza dekamethylzinkonocenu.\footnote[frame]{\href{https://doi.org/10.1126/science.1101356}{Decamethyldizincocene, a Stable Compound of Zn(I) with a Zn-Zn Bond}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Elektronová konfigurace iontu \ce{Zn+} je 3d$^{10}$ 4s$^1$.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Uhličitan zinečnatý, \ce{ZnCO3}, je nerozpustná bílá látka. V přírodě se vyskytuje jako minerál \textit{smithsonit}.\footnote[frame]{\href{https://www.mindat.org/min-3688.html}{Smithsonite}}
