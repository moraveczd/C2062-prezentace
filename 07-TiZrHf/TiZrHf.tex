...
\frame{
	...
	\begin{itemize}
		...
		\item Nejstabilnějším izotopem je \ce{^{267}Rf} s poločasem rozpadu 48 minut.
...
\frame{
	...
	\begin{itemize}
		...
		\item Následně se redukuje taveninou hořčíku (T$_{\textrm{t}}$ = 650~$^\circ$C) v uzavřeném reaktoru v atmosféře argonu.\footnote[frame]{\href{https://www.essentialchemicalindustry.org/metals/titanium.html}{Titanium}}
...
\vfill
\begin{itemize}
	\item Oxid titaničitý se vyrábí dvěma způsoby.\footnote[frame]{\href{https://www.essentialchemicalindustry.org/chemicals/titanium-dioxide.html}{Titanium dioxide}}
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{ZrCl4 + CH4 ->[H2] ZrC + 4 HCl}
	\end{itemize}
	\vfill
}
