...
\frame{
	...
	\begin{columns}
		...
		\begin{itemize}
			...
			\item $\gamma$-Fe -- FCC
			\item $\delta$-Fe -- BCC
			\item $\epsilon$-Fe - vysokotlaká modifikace, nad 10~GPa. Nejtěsnější hexagonální uspořádání.\footnote[frame]{\href{https://www.jstor.org/stable/1714581?seq=1\#metadata_info_tab_contents}{High-Pressure Polymorph of Iron}}
		\end{itemize}
...
\frame{
	\frametitle{}
	\begin{figure}
		\adjincludegraphics[height=.6\textheight]{img/IronAlfa-Gamma.png}
		\caption*{Alotropické modifikace železa.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:IronAlfa\%26IronGamma.svg}{Commons}}}
	\end{figure}
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Čisté \textit{železo} je do teploty 768~$^\circ$C (Curieho teplota\footnote[frame]{Nad Curieovou teplotou ztrácí látka své feromagnetické vlastnosti.}) feromagnetické.
...
\frame{
	...
	\begin{itemize}
		...
		\item Je to feromagnetický kov s Curieovou teplotou 1115~$^\circ$C.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Nikl je feromagnetický za laboratorní teploty, Curieova teplota je 354~$^\circ$C.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Surovinou pro výrobu železa jsou železné rudy:
		\begin{itemize}
			\item Magnetit -- \ce{Fe3O4}
			\item Hematit -- \ce{Fe2O3}
		\end{itemize}
		\item Výroba \textit{surového železa} probíhá ve \textit{vysoké peci}, což je 30--50 m vysoká pec, vyzděná žáruvzdorným materiálem.\footnote[frame]{\href{https://www.lunacek.cz/vysoke-pece-vitkovice-kdyz-zelezo-jeste-teklo/1-uvod-kdyz-zelezo-jeste-teklo/}{Když železo ještě teklo}} Teplota uvnitř pece může dosahovat až 2300~$^\circ$C.\footnote[frame]{\href{https://www.youtube.com/watch?v=b3BOMfH7Dbc}{Jak se vyrábí železo a ocel}}
		\item Jde o kontinuální proces, který může běžet bez výhasu i více než deset let.
		\item Shora se pec zaváží směsí železné rudy, koksu a vápence (struskotvorné látky\footnote[frame]{\href{https://web.archive.org/web/20220709142715/http://www.strusky.cz/}{Struska}}). Zdola se do pece vhání předehřátý vzduch s vyšší koncentrací kyslíku.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item \textit{Oceli} jsou slitiny železa s uhlíkem a dalšími prvky, které obsahují \textit{méně než 2~\% uhlíku}.
		...
		\item Obsah uhlíku se snižuje zaváděním kyslíku do taveniny surového železa v konvertorech.
		\item Zároveň se upravuje i koncentrace dalších kovů a křemíku.
	\end{itemize}
...
\frame{
	\frametitle{}
	\vfill
	\textbf{Typy ocelí}\footnote[frame]{\href{https://www.servicesteel.org/resources/steel-grades}{Types of steel \& steel grades chart}}

	\begin{tabular}{|l|l|l|l|}
		\hline
		\textbf{Typ oceli} & \textbf{Obsah C [\%]} & \textbf{Obsah Si [\%]} & \textbf{Příklad využití} \\\hline
		Konstrukční & 0,05--0,25 & 0,1--0,4 & Nosníky, plechy \\\hline
		Strojní & 0,3--0,6 & 0,2--0,5 & Hřídele, kola \\\hline
		Pružinová & 0,5--0,7 & 1--2 & Pružiny \\\hline
		Elektrotechnická & $<$0,05 & 2--4,5 & \makecell{Transformátorové\\plechy} \\\hline
		Nástrojová & 0,8--1,5 & 0,2--1 & Nosníky, plechy \\\hline
	\end{tabular}

	\begin{itemize}
		\item Uhlík určuje mechanické vlastnosti oceli (tvrdost, pevnost, kalitelnost).
		\item Křemík se používá ke zpevnění, dezoxidaci a zejména ke zlepšení magnetických vlastností elektrotechnických ocelí.
	\end{itemize}
	\vfill
}

\subsubsection{Zelená ocel}
\frame{
	\frametitle{}
	\textbf{Zelená ocel}
	\begin{itemize}
		\item Ocelářský průmysl je největším producentem \ce{CO2} na světě (7--9 \%).
		\item Jednou z možností, jak snížit objem výroby \ce{CO2} je redukce oxidů pomocí vodíku místo koksu.\footnote[frame]{\href{https://www.weforum.org/stories/2022/07/green-steel-emissions-net-zero/}{What is green steel and why does the world need more of it?}}$^,$\footnote[frame]{\href{https://interestingengineering.com/innovation/worlds-first-million-ton-hydrogen-steel-production}{‘World’s first’ million-ton full-scale hydrogen steel line begins operation in China}}
		\item Další cestou, jak snížit ekologickou zátěž je elektrolytická výroba železa, je ovšem nutno využívat bezemisní elektřinu.\footnote[frame]{\href{https://www.osel.cz/13951-zelena-ocelarna-boston-metal-spustila-elektrolyticky-reaktor.html}{Zelená ocelárna Boston Metal spustila elektrolytický reaktor}}$^,$\footnote[frame]{\href{https://newatlas.com/energy/green-steel-plant-boston-metal/}{Green steel plant glugs out first ton of molten metal}}
		\item Elektrolýza oxidů železa s vhodným elektrolytem (tavidlem) vede k tzv. \textit{zelené oceli}.
	\end{itemize}
	\vfill
}
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			...
			\begin{itemize}
				...
				\end{enumerate}
				\item Malá množství kobaltu jsou přítomna i v cigaretovém kouři.\footnote[frame]{\href{https://doi.org/10.3390/ijerph8020613}{Hazardous Compounds in Tobacco Smoke}}
			\end{itemize}
		\end{column}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Kobalt se získává jako vedlejší produkt při výrobě niklu, mědi nebo olova.
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{Ni + 4 CO ->[150 $^\circ$C, 5-15 MPa] Ni(CO)4}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{itemize}
				\item Železo je nejpoužívanější kov, v Evropě se využíval už téměř před 3000 let.\footnote[frame]{\href{https://phys.org/news/2023-02-steel-europe-years.html}{Steel was already being used in Europe 2,900 years ago, shows study}}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item \textbf{Legovaná ocel} vzniká přidáváním dalších prvků do nízkouhlíkové oceli.\footnote[frame]{\href{https://web.archive.org/web/20201229070119/https://svanda.webz.cz/vyuka/legury.htm}{Vliv legovacích prvků na vlastnosti ocelí}} Cílem je optimalizace vlastností.
		\begin{itemize}
	...
	\begin{columns}
		\begin{column}{.55\textwidth}
			\begin{itemize}
				...
				\item Jsou feromagnetické a využívají pro výrobu velmi silných magnetů. Silnější jsou jen neodymové magnety.
...
\frame{
	\frametitle{}
	\textbf{Nerezové mýdlo}
	\begin{itemize}
		\item Zajímavou aplikací nerezové oceli je i tzv. \textit{nerezové mýdlo}.\footnote[frame]{\href{https://zeptejsevedce.cz/dotazy-a-odpovedi/jak-funguje-nerezove-mydlo/}{Jak funguje nerezové mýdlo?}}
		\item Nerezové mýdlo není nic jiného než kus nerezové oceli ve tvaru kostky mýdla. Nerezová ocel nemá žádné účinky proti mikrobům, využívá se pouze k odstranění pachu, např. z rukou po krájení česneku.\footnote[frame]{\href{https://doi.org/10.1308/rcsann.2010.92.8.716b}{Stainless steel soap keeps hands fresh}}
		\item Nerezová ocel dokáže na svůj povrch navázat sloučeniny způsobující zápach, např. alicin a pak katalyzovat jejich rozklad.
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=.6\textwidth]{img/R-allicin-2D-skeletal.png}
		\caption*{Strukturní vzorec alicinu.}
	\end{figure}
}
	...
	\begin{columns}
		\begin{column}{.75\textwidth}
			...
			\begin{itemize}
				...
				\item Strukturu hexahydrátu můžeme popsat vzorcem\\ \textit{trans}-\ce{[Fe(H2O)4Cl2]Cl.2H2O}.\footnote[frame]{\href{https://doi.org/10.1007/s10953-018-0756-6}{Ferric Chloride Complexes in Aqueous Solution: An EXAFS Study}}
...
\frame{
	\frametitle{}
	\vfill
	\textbf{Deriváty ferrocenu}
	\begin{itemize}
		\item Ferrocen je možné derivatizovat substitucí vodíku na cyklopentadilenylech nebo oxidací železnatého kationtu na železitý.
		\item Železnatý ion je možné oxidovat např. bezochinonem v přítomnosti kyseliny tetrafluoroborité, vzniká tetrafluoroboritan ferrocenia, \ce{[Cp2Fe][BF4]}.
	\end{itemize}
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.35\textheight]{img/Biferrocene.png}
				\caption*{Jednoelektronovou oxidací ferrocenu získáme \textit{biferrocen}.}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.35\textheight]{img/Hexaferrocenylbenzene-3D-sticks.png}
				\caption*{Hexaferrocenylbenzen.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:Hexaferrocenylbenzene-3D-sticks.png}{Ben Mills/Commons}}}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{Fe2O3 + 3 KNO3 + 4 KOH -> 2 K2FeO4 + 3 KNO2 + 2 H2O}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.6\textwidth}
			\begin{figure}
				\adjincludegraphics[width=.85\textwidth]{img/K2FeO4-xtal.png}
				\caption*{Krystalová struktura železanu draselného.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:K2FeO4-xtal-1982-CM-3D-balls.png}{Ben Mills/Commons}}}
			\end{figure}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Při teplotách pod 16 $^\circ$C je \textit{antiferomagnetický}.
