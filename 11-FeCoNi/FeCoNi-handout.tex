...
\frame{
	...
	\begin{itemize}
		...
		\item Jednou z možností, jak snížit objem výroby \ce{CO2} je redukce oxidů pomocí vodíku místo koksu.\footnote[frame]{\href{https://www.weforum.org/stories/2022/07/green-steel-emissions-net-zero/}{What is green steel and why does the world need more of it?}}
		...
		\item Elektrolýza oxidů železa s vhodným elektrolytem (tavidlem) vede k tzv. zelené oceli.
	\end{itemize}
	\vfill
}
