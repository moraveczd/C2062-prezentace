...
\frame{
	...
	\begin{itemize}
		...
		\item Studuje funkci anorganických látek v biologických systémech.\footnote[frame]{\href{https://cs.wikibooks.org/wiki/Anorganick\%C3\%A1_chemie/Bioanorganick\%C3\%A1_chemie}{Bioanorganická chemie}}
	\end{itemize}
	\begin{figure}
...
\frame{
	...
	\begin{tabular}{|c|c|l|}
		...
		Zn & 2000--3000 & Lewisova kyselina \\\hline
		Fe & 3000--4000 & FeS proteiny, přenos a ukládání \ce{O2} a \ce{CO2} \\\hline
...
\frame{
	...
	\begin{itemize}
		...
		\item Procesu, kdy z oxidu uhličitého a vody vzniká v přítomnosti světla cukr a kyslík.
	\end{itemize}
	\begin{figure}
...
\frame{
	...
	\begin{itemize}
		...
		\item Nachází se v krevních buňkách mořských pláštěnců a dalších organismů.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Chrom se v organismech vyskytuje především v oxidačních stavech +III a +VI.\footnote[frame]{\href{https://ods.od.nih.gov/factsheets/Chromium-HealthProfessional/}{Chromium (NIH)}}
		\item Chromité sloučeniny jsou považovány za biologicky aktivní, jsou spojovanými s regulací metabolismu sacharidů a lipidů (zvyšování účinku inzulinu).\footnote[frame]{\href{https://www.wikiskripta.eu/w/Chrom}{Chrom}}
		\item Chromité ionty se v organismech váží na nízkomolekulární ligandy a bílkoviny (např. tzv. \emph{chromodulin}).
		\item Chrom v oxidačním stavu VI je vysoce toxický a karcinogenní, snadno proniká buněčnými membránami.
		\item Toxicita chromu souvisí s jeho silnou oxidační schopností a tvorbou reaktivních meziproduktů.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Je součástí molybdoenzymů, která obsahují \ce{Fe-S} motiv a molybden oktaedricky koordinovaný sírou.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item \textbf{Wolfram} je nejtěžším známým esenciálním kovem, který se vyskytuje v biologických systémech.
	...
	\begin{figure}
		...
		\caption*{Mechanismus funkce aldehyd ferredoxin oxidoreduktázy.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:AOR_Mechanism.jpg}{jejeni6/Commons}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Také má důležitou roli v metabolismu cukrů.
		\item Nadbytek manganu může vést k problémům v nervové soustavě a dlouhodobě zvýšený příjem může způsobit až Parkinsonovu nemoc.\footnote[frame]{\href{https://doi.org/10.1016/j.neuro.2005.10.006}{The diagnosis of manganese-induced parkinsonism}}
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			...
			\begin{itemize}
				...
				\item Kromě kyslíku, transportuje hemoglobin i \ce{CO2} (karbaminohemoglobin).
			\end{itemize}
			\vfill
		\end{column}
		\begin{column}{.35\textwidth}
...
\frame{
	...
	\begin{itemize}
		...
		\item Tyto proteiny mají funkci transferu elektronů (oxidoreduktasy).
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Je složkou vitamínu B12, označovaného jako \textit{kobalamin}, ten je esenciální pro metabolismus všech živočichů.
...
\frame{
	...
	\begin{itemize}
		...
		\item Nejvíce nebezpečné jsou organortuťnaté sloučeniny, např. \ce{Me2Hg}.
...
\frame{
	...
	\begin{itemize}
		...
		\item Toxické účinky lze vysvětlit vazbou olova na SH- skupiny enzymů, čímž dochází k jejich deaktivaci.\footnote[frame]{\href{https://web.archive.org/web/20200720000124/https://web2.mendelu.cz/af_239_nanotech/J_Met_Nano/0314/pdf/jmn3-08.pdf}{Působení olova na živé organismy}}
	...
	\begin{columns}
		\begin{column}{.75\textwidth}
			\begin{itemize}
				...
				\item Doporučená denní dávka selenu pro člověka je 60--75~$\mu$g.\footnote[frame]{\href{https://www.nzip.cz/clanek/1153-selen}{Selen}}
