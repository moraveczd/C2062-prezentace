...
\frame{
	\frametitle{}
	\huge Elektronové konfigurace přechodných kovů a jejich iontů -- PSP
}
...
\frame{
	\frametitle{}
	\huge VSEPR, SYMETRIE, DIPOLMOMENT
}
...
\section{Otázky k procvičení}
\frame{
	\frametitle{}
	\vfill
	\large Vyberte paramagnetické částice:
	\begin{itemize}
		\item Al
		\item Al$^{3+}$
		\item Fe
...
\frame{
	\frametitle{}
	\vfill
	\large Vyberte planární molekuly a ionty:
	\begin{itemize}
		\item \ce{NH3}
		\item \ce{SO3}
		\item \ce{BF3}
...
\frame{
	\frametitle{}
	\vfill
	\large Co je to eutektikum, intermetalikum a ocel?
	\vfill
}
...
\frame{
	\frametitle{}
	\vfill
	\large Proč je sodík výrazně měkčí než železo?
	\vfill
}
