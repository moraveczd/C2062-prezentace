	...
	\begin{columns}
		\begin{column}{.65\textwidth}
			\begin{itemize}
				...
				\item Výroba \ce{^{210}Po} probíhala do roku 2022 v Rusku. Měsíčně se vyrobilo asi 8 g.\footnote[frame]{\href{https://hps.org/documents/polonium_210_story.pdf}{Why \ce{^{210}Po}?}}
			\end{itemize}
		\end{column}
