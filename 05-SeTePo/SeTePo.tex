...
\frame{
	...
	\hline
	 ...
	 T. tání [$^\circ$C] & 221 & 449,51 & 254 \\\hline
	 T. varu [$^\circ$C]  & 685 & 987,85 & 962 \\\hline
		...
		\begin{columns}
			\begin{column}{.7\textwidth}
				\begin{itemize}
					...
					\item Nejstabilnějším izotopem je \ce{^{293}Lv} s poločasem rozpadu asi 60~ms.\footnote[frame]{\href{https://en.wikipedia.org/wiki/Isotopes_of_livermorium}{Isotopes of livermorium}}
					\item \ce{^{293}Lv ->[$T_{\frac{1}{2}}$ $\sim$ 60 ms] ^{289}Fl + $\alpha$}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Selen i tellur tvoří několik allotropních modifikacích.\footnote[frame]{\href{https://www.youtube.com/watch?v=BsO-tV2XK8M}{Selenium. Red-Black Transformations -- YouTube}}
	...
	\end{itemize}
		...
		\begin{figure}
		\adjincludegraphics[height=0.2\textheight]{img/Cyclooctaselenium.png}
		\caption*{Struktura \ce{Se8}.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:Cyclooctaselenium-3D-balls.png}{Ben Mills/Commons}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{figure}
		\adjincludegraphics[height=0.4\textheight]{img/Black_Selenium.jpg}
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{Na2SeO3 + 2 SO2 + H2O -> Se + Na2SO4 + H2SO4}
	\end{itemize}
	\vfill
}
	...
	\begin{columns}
		\begin{column}{.65\textwidth}
			\begin{itemize}
				...
				\item Výroba \ce{^{210}Po} probíhala do roku 2022 v Rusku. Měsíčně se vyrobilo asi 8 g.\footnote[frame]{\href{https://hps.org/wp-content/uploads/2024/12/polonium_210_story.pdf}{Why \ce{^{210}Po}?}}
			\end{itemize}
		\end{column}
	...
	\begin{columns}
		\begin{column}{.6\textwidth}
			...
			\begin{itemize}
				...
				\item Byl vynalezen v letech 1937--1942, dnes už jde o historickou technologii.
...
\frame{
	...
	\begin{itemize}
		...
		\item Tento izotop bývá také označován za hlavní příčinu rakoviny plic u~kuřáků, protože se vyskytuje v tabákovém kouři.\footnote[frame]{\href{https://web.archive.org/web/20220528144633/https://www.cdc.gov/nceh/radiation/polonium-210.htm}{Facts About Exposure to Polonium-210 from Naturally-Occurring Sources}}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Chalkogenidy jsou sloučeniny chalkogenů s elektropozitivnějšími prvky.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item \textbf{Selan}, \ce{H2Se}, je bezbarvý, toxický, páchnoucí plyn.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Selan má podobné vlastnosti jako sulfan (p$K_a$ = 6,89), ale je kyselejší (p$K_a$ = 3,89).\footnote[frame]{\href{https://doi.org/10.1021/j100383a020}{Spectroscopic determination of the second dissociation constant of hydrogen selenide and the activity coefficients and spectral shifts of its ions}}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.6\textwidth]{img/SeO3.png}
		\caption*{Krystalová struktura tetrameru \ce{SeO3}}
	\end{figure}
	\vfill
}
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{itemize}
				...
				\item Doporučená denní dávka selenu pro člověka je 50~$\mu$g.den$^{-1}$.\footnote[frame]{\href{https://www.wikiskripta.eu/w/Selen}{Selen}}
...
\frame{
	...
	\end{figure}
	\begin{itemize}
		\item Syntetické léčivo \textit{ebselen} má anti-oxidační účinky a zdál se být slibným léčivem proti COVID-19.\footnote[frame]{\href{https://www.nature.com/articles/s41586-020-2223-y}{Structure of Mpro from SARS-CoV-2 and discovery of its inhibitors}}
		...
		\item Tato látka se nedostala do klinické praxe jako antivirotikum, ale je stále studována jako antioxidant.
	\end{itemize}
	\begin{figure}
