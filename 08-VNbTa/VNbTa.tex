...
\frame{
	...
	\begin{columns}
		...
		\item \ce{^{243}_{95}Am + ^{22}_{10}Ne -> ^{261}_{105}Db + 4 ^1_0n}
		\item \ce{^{243}_{95}Am + ^{22}_{10}Ne -> ^{260}_{105}Db + 5 ^1_0n}
...
\frame{
	...
	\begin{itemize}
		\item Elektronová konfigurace niobu je odlišná od vanadu a tantalu:\footnote[frame]{\href{https://winter.group.shef.ac.uk/webelements/niobium/atoms.html}{Niobium - $_{41}$Nb: properties of free atoms}}
			\begin{itemize}
				\item 4d$^4$ 5s$^1$
				\item Elektronová konfigurace niobu se liší od vanadu a tantalu, protože u Nb jsou energiové úrovně 4d a 5s téměř stejné, takže se vyplatí přesun elektronu do d‑orbitalu, zatímco u V je rozdíl příliš velký a u Ta zase relativistické efekty stabilizují 6s$^2$.
			\end{itemize}
...
\frame{
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Tímto procesem získáme slitinu feroniob nebo ferotantal.\footnote[frame]{\href{https://www.usgs.gov/centers/nmic/ferroalloys-statistics-and-information}{Ferroalloys Statistics and Information}}
		\end{itemize}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Hlavní využití nachází vanad jako příměs do ocelí (\textit{ferovanad}).
		...
		\item Nejběžnějším typem ferovanadu je FeV80, který obsahuje 80~\% vanadu.
		\item Vyrábí se z oxidu vanadičného redukcí ferosiliciem nebo hliníkem.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Vanadové redoxní baterie jsou typem průtočných baterií, mohou být velmi významnou technologií pro zálohování obnovitelných zdrojů elektrické energie.\footnote[frame]{\href{https://web.archive.org/web/20240419162752/https://www.vscht.cz/popularizace/doktorandi-pisou/kam-s-elektrinou}{Kam s elektřinou? Řešením mohou být vanadové průtočné baterie}}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Slitiny niobu s dalšími kovy (Ti, Fe, Hf, Ta) se využívají v kosmických technologiích pro konstrukci trysek motorů na kapalné paliva.\footnote[frame]{\href{https://niobium.tech/-/media/niobiumtech/attachments-biblioteca-tecnica/nt_niobium-alloys-and-high-temperature-applications.pdf}{Niobium Alloys and High Temperature Applications}}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.75\textwidth}
			\begin{itemize}
				\item Anoda kondenzátoru je tvořena kovovým tantalem, vyrábí se lisováním práškového tantalu na tantalový drát ve vakuu při teplotě 1500--2000~$^\circ$C.\footnote[frame]{\href{https://web.archive.org/web/20210708035316/https://www.avx.com/docs/techinfo/Tantalum-NiobiumCapacitors/bsctant.pdf}{Basic tantalum capacitor technology}}
...
\frame{
	...
	\vfill
		...
		\begin{column}{.25\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/mlok.jpg}
...
\frame{
	...
	\begin{itemize}
		...
		\item Je amfoterní, ochotně se rozpouští v kyselinách za vzniku dioxovanadičného kationtu \ce{(VO2)+}, v roztocích alkalických hydroxidů tvoří orthovanadičnanové ionty \ce{VO$_4^{3-}$}.\footnote[frame]{\href{https://commons.wikimedia.org/wiki/File:Reakce_oxidu_vanadi\%C4\%8Dn\%C3\%A9ho_s_hydroxidem_draseln\%C3\%BDm.webm}{Reakce oxidu vanadičného s hydroxidem draselným}}
	\end{itemize}
	\begin{figure}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.75\textwidth}
			\begin{itemize}
				\item Chlorid vanadičný, \ce{VCl5}, je nestabilní černá látka.
				\item Vytváří dimerní molekuly \ce{V2Cl10}, jsou tvořeny oktaedry propojenými přes hranu.\footnote[frame]{\href{https://doi.org/10.1002/anie.201207552}{The Elusive Halides VCl$_5$, MoCl$_6$, and ReCl$_6$}}
				\item \ce{2 VF5 + 10 BCl3 ->[-78 $^\circ$C] V2Cl10 + 10 BF2Cl}
				\item \textbf{Chlorid vanadičitý}, \ce{VCl4}, je jedovatá, červenohnědá kapalina.
