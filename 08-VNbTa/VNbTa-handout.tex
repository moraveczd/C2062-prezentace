...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Tantal má hlavní využití v elektronice, využívá se při výrobě \textit{tantalových kondenzátorů}.
...
\frame{
	...
	\begin{itemize}
		...
		\item Vytvářejí sloučeniny v rozmezí oxidačních čísel \textbf{-III až V}.
		\item Koordinační číslo může dosahovat až hodnoty 8.
