...
\frame{
	...
	\vfill
		\begin{itemize}
			\item Komplexy iontů s konfigurací d$^8$ (\ce{Rh^I}, \ce{Ir^I}, \ce{Pd^{II}}, \ce{Pt^{II}} a \ce{Au^{III}}) \textit{preferují čtvercovou geometrii oproti tetraedrické}.
			...
			\item Čtvercové komplexy jsou zpravidla \textit{nízkospinové}.
