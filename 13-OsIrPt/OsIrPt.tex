...
\frame{
	...
	\hline
	 ...
	 El. konfigurace & 4f$^{14}$ 5d$^{6}$ 6s$^{2}$ & 4f$^{14}$ 5d$^{7}$ 6s$^{2}$ & 4f$^{14}$ 5d$^{9}$ 6s$^{1}$ \\\hline
	...
	\begin{columns}
		\begin{column}{0.6\textwidth}
			...
			\begin{itemize}
				...
				\item První příprava byla publikována roku 1984, terč z olova byl bombardován jádry železa:
...
\frame{
	\frametitle{}
		...
		\begin{itemize}
			...
			\item Reakcí oxidu s alkalickými hydroxidy vznikají bazické hassičelany:\footnote[frame]{\href{https://web.archive.org/web/20210729084845/https://www-windows.gsi.de/superheavies/english/publications/pub_images/pub_annual_img/annual_reports_2003/SHE_AR_2003_172.pdf}{Final result of the CALLISTO-experiment: Formation of sodium hassate(VIII)}}
	...
	\begin{columns}
		\begin{column}{0.6\textwidth}
			...
			\begin{itemize}
				...
				\item Nemá žádný stabilní izotop.
				\item Pojmenován byl v roce 1997 podle rakouské fyzičky Lise Meitner\footnote[frame]{\href{https://cs.wikipedia.org/wiki/Lise_Meitnerová}{Lise Meitnerová}}, která se zabývala studiem radioaktivity.\footnote[frame]{\href{http://publications.iupac.org/pac/pdf/1997/pdf/6912x2471.pdf}{Names and symbols of transfermium elements}}
	...
	\begin{columns}
		\begin{column}{0.6\textwidth}
			...
			\begin{itemize}
				...
				\item První příprava byla publikována roku 1994, terč z olova byl bombardován jádry niklu:\footnote[frame]{\href{https://doi.org/10.1007/BF01291181}{Production and decay of $^{269}$110}}
...
\frame{
	...
	\begin{itemize}
		...
		\item V Evropě byla platina objevena až v roce 1736.\footnote[frame]{\href{https://web.archive.org/web/20240812103838/https://www.bbvaopenmind.com/en/science/leading-figures/antonio-de-ulloa-the-discoverer-of-platinum/}{Antonio de Ulloa: the Discoverer of Platinum?}}
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			...
			\begin{itemize}
				...
				\item Slitina 90~\% platiny a 10~\% iridia byla použita pro konstrukci etalonu metru a kilogramu.\footnote[frame]{\href{https://www.nist.gov/image/meter-bar-27}{Meter Bar 27}}
...
\frame{
	...
	\begin{columns}
		...
		\column{.45\textwidth}
		\begin{itemize}
			\item \textbf{Standardní vodíková elektroda} (SVE) - platinový drátek pokrytý platinovou černí, sycený plynným vodíkem pod tlakem 101 325 Pa za teploty 298,15 K, ponořený do roztoku o jednotkové aktivitě H$^+$. Tato elektroda má nulový elektrodový potenciál.
		\end{itemize}
		\column{.25\textwidth}
		\begin{figure}
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{itemize}
				...
				\item Sublimuje za laboratorní teploty, je izoelektronový s \ce{MnO^-_4}.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Jediným izolovatelným oxidem iridia je \ce{IrO2}, krystaluje ve struktuře rutilu.
