...
\frame{
	...
	\begin{itemize}
		...
		\item[1D] Jeden rozměr výrazně převažuje nad zbylými, např. nanotrubice.
	...
	\begin{columns}
		\begin{column}{.75\textwidth}
			\begin{itemize}
				...
				\end{itemize}
				\item V současnosti známe stovky druhů 2D materiálů, převážně jde o oxidy, chalkogenidy a dichalkogenidy (TMD -- Transition Metals Dichalcogenides):
				\begin{itemize}
...
\frame{
	...
	\begin{itemize}
		...
		\item Pohyblivost elektronů v grafenu je 15 000 cm$^2$.V$^{-1}$.s$^{-1}$, což je o tři řády více než u křemíku.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Zatím ale jde pouze o zajímavost, která je v rané fázi výzkumu.
	\end{itemize}
	\vfill
	\end{column}
	\begin{column}{0.4\textwidth}
		\begin{figure}
			\adjincludegraphics[width=\textwidth]{img/graphullerene.png}
			\caption*{Struktura grafullerenu.\footnote[frame]{Zdroj: \href{https://www.nature.com/articles/s41524-023-01167-5}{Nature}}}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item Dá se očekávat, že v dohledné době začnou doplňovat křemík v elektronických aplikacích.
...
\frame{
	...
	\begin{itemize}
		...
		\item Měřením bylo zjištěno, že činitel tření má hodnotu nižší než $10^{-6}$, což je extrémně nízká hodnota.\footnote[frame]{\href{https://doi.org/10.1038/s41563-021-01058-4}{UItra-low friction and edge-pinning effect in large-lattice-mismatch van der Waals heterostructures}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Podle měření se teploty uvnitř kolabující bubliny pohybuje okolo 5000~K a také v okolní kapalině dosahuje velice vysokých hodnot.
	\end{itemize}
	\begin{figure}
...
\frame{
	...
	\begin{itemize}
		...
		\item Vychází z několika idealizovaných předpokladů:
		\begin{itemize}
...
\frame{
	...
	\begin{itemize}
		...
		\item Snímání objektu probíhá zpravidla ve vakuu a vzorky by měly být vodivé. Nevodivé musí být pokryty vodivou vrstvou, např. grafitem nebo zlatem.
	\end{itemize}
	\vfill
}
