	...
	\begin{columns}
		\begin{column}{.72\textwidth}
			\begin{itemize}
				...
				\item Název byl schválen roku 1997, jde o jeden ze dvou prvků pojmenovaných po žijícím vědci.\footnote[frame]{\href{https://doi.org/10.1351/pac199769122471}{Names and symbols of transfermium elements (IUPAC Recommendations 1997)}}
				...
				\item \ce{^{248}_{\ \ 96}Cm + ^{22}_{10}Ne -> ^{265}_{106}Sg + 5 ^1_0n}
			\end{itemize}
		\end{column}
...
\frame{
	...
	\begin{itemize}
		...
		\item Za vyšší teploty reaguje s kyslíkem a chlorovodíkem za vzniku chlorid-oxidu:
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			...
			\begin{itemize}
				...
				\item Chrom je jediný stabilní prvek, který je za laboratorní teploty \textit{antiferomagnetický} (viz slide \ref{ChromAntifer}).\footnote[frame]{\href{https://doi.org/10.1103/RevModPhys.60.209}{Spin-density-wave antiferromagnetism in chromium}}
...
\frame{
	...
	\begin{column}{.7\textwidth}
		\begin{itemize}
			\item Chrom je \textit{antiferomagnetický}, tzn. že má magnetické domény orientované opačně, navzájem se jejich vliv ruší.
...
\frame{
	...
	\textbf{Uvarovit}
	\begin{itemize}
		\item Kubický minerál, \ce{Ca3Cr2(SiO4)3}, smaragdově zelená barva je způsobená přítomností chromu.\footnote[frame]{\href{http://mineraly.sci.muni.cz/nesosilikaty/uvarovit.html}{Uvarovit}}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Chrom se vyrábí buď v kovové formě nebo přímo jako slitina \textit{ferochrom}.\footnote[frame]{\href{https://www.sciencedirect.com/topics/materials-science/ferrochrome}{Ferrochrome -- ScienceDirect}}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Redukcí chromitu (\ce{FeCr2O4}) uhlíkem získáme slitinu ferochrom (FeCr).
		...
		\item Většina vyrobeného ferochromu se využívá pro výrobu nerezové oceli, která obsahuje přibližně 18~\% chromu.\footnote[frame]{\href{https://www.fasteners-cz.cz/druhy-nerezove-oceli-priklady-jejiho-uziti}{Druhy nerezové oceli a příklady jejího užití}}
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.35\textheight]{img/Ferrochrome.jpg}
		\caption*{Ferochrom.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:Ferrochrome.JPG}{FocalPoint/Commons}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Oxid molybdenový lze využít přímo nebo se aluminotermicky převádí na \textit{feromolybden}.\footnote[frame]{\href{https://www.azom.com/article.aspx?ArticleID=9884}{Feromolybdenum - Properties, Applications}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Je popsáno 51 minerálů obsahujících wolfram.\footnote[frame]{\href{https://www.mindat.org/element/Tungsten}{The mineralogy of Tungsten}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Kovový molybden se využívá jako katalyzátor pro chemiluminiscenční detekci \ce{NO_x} (\ce{NO2} je nutno redukovat molybdenem na NO a ten následně oxidovat ozonem):\footnote[frame]{\href{https://doi.org/10.1023/A:1010730821844}{Monitoring of Atmospheric Behaviour of NOx from Vehicular Traffic}}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item U sloučenin chromu byla poprvé pozorována paterná vazba.\footnote[frame]{\href{https://www.sciencedaily.com/releases/2005/10/051014072049.htm}{For The First Time, A Five-fold Bond}}
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{K2Cr2O7 + 6 HCl -> 2 CrO2Cl2 + 2 KCl + 3 H2O}
