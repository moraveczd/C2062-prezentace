	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			...
			\begin{itemize}
				...
				\item Chrom je jediný prvek, který je za laboratorní teploty \textit{antiferomagnetický} (viz slide \ref{ChromAntifer}).\footnote[frame]{\href{https://doi.org/10.1103/RevModPhys.60.209}{Spin-density-wave antiferromagnetism in chromium}}
