...
\frame{
	...
	\begin{columns}
		\begin{column}{.6\textwidth}
			\begin{itemize}
				\item Transuran, protonové číslo 107, Bh.
...
\frame{
	...
	\end{center}
	\begin{itemize}
		\item Známe 11 radioizotopů a jeden jaderný izomer. Nejstabilnějším izotopem je \ce{^{274}Bh} s poločasem rozpadu 0,9~minut, příp. nepotvrzený izotop \ce{^{278}Bh} s poločasem rozpadu 11,5~minut.
...
\frame{
	...
	\begin{itemize}
		...
		\item Manganu se ročně spotřebují milióny tun, naproti tomu technecium i~rhenium jsou velmi vzácné prvky.
...
\frame{
	...
	\begin{itemize}
		...
		\item Nejdůležitějším minerálem je \textit{pyroluzit}, \ce{MnO2}.
...
\frame{
	...
	\begin{itemize}
		...
		\item Nesosilikát.\footnote[frame]{Nesosilikáty mají ve své struktuře izolované tetraedry \ce{SiO4}, které jsou v prostoru propojeny přes koordinační polyedry jiných kationtů.}
	\end{itemize}
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Část manganových rud se zpracovává na \textit{feromangan}.
	...
	\begin{figure}
		...
		\caption*{Feromangan.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:Ferromangan\%C3\%A8se_m\%C3\%A9tal.jpg}{Borvan53/Commons}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Mendělejevova tabulka obsahovala mezeru mezi manganem a rheniem. Mendělejev tuto pozici obsadil hypotetickým prvkem \textit{eka-manganem}.
		\item Prvek 43 byl oficiálně izolován a popsán až v roce 1937.
		\item První izolace proběhla z radioaktivní molybdenové fólie, která byla součástí cyklotronu.
		\item Prvek byl v roce 1947 pojmenován \textit{technecium}.
		\item Než se podařilo technecium opravdu izolovat, bylo publikováno i několik mylných identifikací:
	\end{itemize}

	\begin{center}
		\begin{tabular}{|l|l|l|}
			\hline
			\textbf{Rok} & \textbf{Navrhované jméno} & \textbf{Jednalo se o} \\\hline
			1828 & Polinium & Iridium \\\hline
			1845 & Pelopium & Slitina niobu a tantalu \\\hline
			1847 & Ilmenium & Slitina niobu a tantalu \\\hline
			1877 & Davyum & Slitina iridia, rhodia a železa \\\hline
			1896 & Lucium & Yttrium \\\hline
			1908 & Nipponium & Rhenium \\\hline
		\end{tabular}
	\end{center}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Je významnou složkou jaderného odpadu.
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			...
			\begin{itemize}
				...
				\item V ocelářství se využívá \textit{feromangan}, což je slitina manganu a železa s obsahem až 80~\% manganu. Vyrábí se redukcí směsi oxidu manganičitého a železitého koksem ve vysoké nebo elektrické peci.\footnote[frame]{\href{https://www.britannica.com/technology/manganese-processing}{Manganese processing}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Ročně se ho vyrobí asi půl milionu tun.
		\item Koncentrovaná kyselina sírová ho převádí na oxid:
		\item \ce{2 KMnO4 + H2SO4 -> Mn2O7 + K2SO4 + H2O}
		\item Vyrábí se oxidací burelu na manganan:
		\begin{itemize}
			\item \ce{2 MnO2 + 4 KOH + O2 ->[200\ $^\circ\textrm{C}$] 2 K2MnO4 + 2 H2O}
		\end{itemize}
		\item a následnou elektrochemickou oxidací v bazickém prostředí:\footnote[frame]{\href{https://doi.org/10.1021/ie800240m}{Electrosynthesis of Potassium Permanganate in a Cation Exchange Membrane Cell}}
		\begin{itemize}
			\item Anoda: \ce{K2MnO4 -> KMnO4 + K+ + e-}
			\item Katoda: \ce{H2O + e- -> OH- + 1/2 O2}
		\end{itemize}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Sloučeniny tohoto typu jsou označovány jako \textit{monomolekulární magnety} (SMM -- \textit{Single-Molecular Magnets}).
	\end{itemize}
	\begin{figure}
...
\frame{
	...
	\textit{Oxidační stav 0}
	\begin{itemize}
		\item Dekakarbonyldirhenia, \ce{Re2(CO)5}, je bílá krystalická látka s teplotou tání 170~$^\circ$C.
